...
void function InitInGameMPMenu()
{
	...
	// SERVER BROWSER
	var serverBrowser = AddComboButton( comboStruct, headerIndex, buttonIndex++, "#MENU_TITLE_SERVER_BROWSER" )
	Hud_AddEventHandler( serverBrowser, UIE_CLICK, AdvanceMenuEventHandler( GetMenu ( "ServerBrowserMenu" ) ) )
